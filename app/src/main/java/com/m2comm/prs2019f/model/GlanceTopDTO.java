...
public class GlanceTopDTO {
    ...
    private String tab;
    private String mon;
    private ArrayList<Glance_sub_top> subDTOS;


    public GlanceTopDTO(String day_Type, String bottom_menu, String bottom_menu_now, String bottom_menu_program, String bottom_menu_glance, String bottom_menu_myfav, String bottom_menu_category, String session_topmenu_bg, String session_topmenu_font, String menu_bg, String menu_bg_on, String menu_font, String menu_font_on, String session_day_bg, String tab, String mon , ArrayList<Glance_sub_top> subDTOS) {
    ...
    public ArrayList<Glance_sub_top> getSubDTOS() {
        return subDTOS;
    }
